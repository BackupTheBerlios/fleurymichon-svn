...
\chapter{D. Brian Burghart - Money for sex \cite{articleburghart}}
...
\chapter{Del Jones - CEOs say how you treat a waiter can predict a lot about character \cite{articledeljones}}

\section{Summary}

Il y a peu de règles sur lesquelles les chefs d'entreprise peuvent
se baser à coup sûr afin de connaître la vraie personnalité d'un
collaborateur ou employé mais il semblerait qu'une règle sur
laquelle ils sont tous d'accord puisse être extraite. En effet, ce
qu'ils appellent la Règle du Serveur semble tous les mettre
d'accord. Cette règle pourrait se résumer en une phrase :
``Quelqu'un qui est sympathique avec vous mais impoli avec les
serveurs, ou avec les autres, n'est pas quelqu'un sympathique''.\\
De nombreux PDG de grosses entreprises ont un jour été simple serveur
ou ont fait de petits métiers et ont gardé de ces expériences le
fait qu'un serveur n'est pas du tout un quelqu'un d'inférieur. La seule
différence entre eux est leur titre de PDG et leur argent, le fait
de se comporter normalement avec eux montre un certain savoir vivre
et une éducation, que l'argent et les titres n'ont pas altéré. Le
fait d'être serveur ou PDG n'est pas toujours dû à un talent mais
aussi aux aléas de la vie et ne pas se rappeler de ça peut montrer
que vous n'êtes peut-être pas une personne très intelligente et
digne d'intérêt.
